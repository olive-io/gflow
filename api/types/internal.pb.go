...
type Runner_State int32

const (
	Runner_Unknown Runner_State = 0
	Runner_Ok      Runner_State = 1
	Runner_Warn    Runner_State = 2
	Runner_Error   Runner_State = 3
)

var Runner_State_name = map[int32]string{
	0: "Unknown",
	1: "Ok",
	2: "Warn",
	3: "Error",
...
var Runner_State_value = map[string]int32{
	"Unknown": 0,
	"Ok":      1,
	"Warn":    2,
	"Error":   3,
...
func (x Runner_State) String() string {
	return proto.EnumName(Runner_State_name, int32(x))
}

func (Runner_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3f64495044b5fbf5, []int{0, 1}
}
...
type Runner struct {
	...
	State            Runner_State         `protobuf:"varint,21,opt,name=state,proto3,enum=types.Runner_State" json:"state,omitempty"`
...
type RunnerStat struct {
	...
	MemoryUsed    float64 `protobuf:"fixed64,3,opt,name=memory_used,json=memoryUsed,proto3" json:"memory_used,omitempty"`
	State         string  `protobuf:"bytes,4,opt,name=state,proto3" json:"state,omitempty"`
	Error         string  `protobuf:"bytes,5,opt,name=error,proto3" json:"error,omitempty"`
	Timestamp     int64   `protobuf:"varint,6,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Tasks         uint64  `protobuf:"varint,11,opt,name=tasks,proto3" json:"tasks,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("types.Runner_State", Runner_State_name, Runner_State_value)
...
var fileDescriptor_3f64495044b5fbf5 = []byte{
	...
	,
}
...
func (m *RunnerStat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Tasks != 0 {
		i = encodeVarintInternal(dAtA, i, uint64(m.Tasks))
		i--
		dAtA[i] = 0x58
	}
	if m.Timestamp != 0 {
...
func (m *RunnerStat) Size() (n int) {
	...
	if m.Tasks != 0 {
		n += 1 + sovInternal(uint64(m.Tasks))
	}
	if m.CommitCount != 0 {
	...
	for iNdEx < l {
		...
		case 21:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= Runner_State(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
